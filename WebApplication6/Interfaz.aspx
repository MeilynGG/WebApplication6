<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Interfaz.aspx.cs" Inherits="WebApplication6.Interfaz" %>
    ...
    <form>
        ...
        <div class="form-group" style=" width:90%;">
            ...
            <div class="input-group mb-2">
               ...
               <asp:TextBox ID="txt_id" style="border-radius:20px; border-color:black" runat="server"   CssClass="form-control"></asp:TextBox>
            </div>
        ...
        <div class="form-group" style=" width:90%;">
            ...
            <asp:Button ID="Button2" style="border-radius:20px; runat="server"  OnClick="btn_gur_Click" Text="Guardar"  CssClass="btn btn-primary"/>
